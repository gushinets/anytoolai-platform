...
def create_product_handoffs_table(
    *,
    platform_schema: str,
    json_document: sa.TypeEngine,
    handoff_status_type: sa.Enum,
    handoff_start_policy_type: sa.Enum,
) -> None:
    op.create_table(
        "product_handoffs",
        ...
        sa.Column("status", handoff_status_type, nullable=False),
        ...
        sa.Column("target_start_policy", handoff_start_policy_type, nullable=False),
