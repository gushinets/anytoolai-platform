...
| Handoff model | B+ | Generic backend token lifecycle, guarded persistence, safe previews, linked immediate/deferred sessions, event correlation, API and worker-lineage tests are implemented; A18 still owns the web/CE consent surface. | Backend | 2026-07-22 |
