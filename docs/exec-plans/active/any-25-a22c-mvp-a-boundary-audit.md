...
- Next action: none — implementation, three internal code-review rounds, and twenty-three GitHub
  ...
  imports, only recognizing `from`/`require(`; only the temp-tree-regression-fixture ask remains
  deferred as follow-up debt — see those entries); move to `completed/` once merged.
- Blocker: none
